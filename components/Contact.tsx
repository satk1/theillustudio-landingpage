      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        <ScrollReveal>
          ...
          <a 
            ...
            className="inline-block text-3xl md:text-4xl font-display font-semibold text-accent hover:underline mb-6"
          >
          ...
          <div className="mb-8">
            <a 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#25D366] text-white rounded-full font-medium hover:bg-[#20BA5A] transition transform hover:scale-105"
            >
